...
import com.iram.acteur.service.ImageService;
...
public class ImageRESTController {
	 ...
	 @PostMapping(value = "/uplaodImageAct/{idAct}" )
	 public Image uploadMultiImages(@RequestParam("image")MultipartFile file,
			 @PathVariable("idAct") Long idAct) 
					 throws IOException {
		 return imageService.uplaodImageAct(file,idAct);
	 }
	 
	 @RequestMapping(value = "/getImagesAct/{idAct}" , method = RequestMethod.GET)
	 public List<Image> getImagesAct(@PathVariable("idAct") Long idAct) 
			 throws IOException {
		 return imageService.getImagesParAct(idAct);
	 }
